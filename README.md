...
## Environments
- Preview: https://main--ue-forms-boilerplate--lovelymandal16.hlx.page/
- Live: https://main--ue-forms-boilerplate--lovelymandal16.hlx.live/
...
1. Open the `ue-forms-boilerplate` directory in your favorite IDE and start coding :)
